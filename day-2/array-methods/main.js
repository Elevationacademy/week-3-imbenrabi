...
//EX 01
const emailAndCompany = users.map( u => { return {email: u.email, company: u.company.name} });
console.log(emailAndCompany);

//Ex 02 - 03
const zipCodeStartsWithFive = 
    users
...
//Ex 04
const cNames = users.filter( u => u.name.startsWith('C') );
console.log(cNames);
